...
all_aop_landcover <- fs::dir_ls("/research-home/rswanwick/neon-workshop-data/data/nlcd", regexp = "Land_Cover") %>%
...
all_aop_landcover_areas <- fs::dir_ls("/research-home/rswanwick/neon-workshop-data/data/nlcd", regexp = "Land_Cover") %>%
  purrr::map_df(~readr::read_csv(.x)) %>% 
...
all_aop_impervious <- fs::dir_ls("/research-home/rswanwick/neon-workshop-data/data/nlcd", regexp = "Impervious") %>%
  purrr::map_df(~readr::read_csv(.x)) %>%
