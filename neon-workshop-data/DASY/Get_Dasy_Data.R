...
sjob <- slurm_map(global_objects = "Get_Dasy_Data", fips_list, get_dasy_all_counties, jobname = 'DASYallcounties',
                  nodes = 6, cpus_per_node = 8, pkgs = c("tidycensus", "raster", "tidyverse", "FedData", "sf", "dplyr", "glue"),
                  submit = TRUE)
